...
$testModels = array(
    array('Sliced', INSTANCE_TESTMODEL_EKSTERA_SLICED, 'oat\\ekstera\\model\\sliced\\SlicedModel'),
    array('Remote', INSTANCE_TESTMODEL_EKSTERA_REMOTE, 'oat\\ekstera\\model\\remote\\RemoteModel')
);
